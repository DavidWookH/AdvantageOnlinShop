...
def test():
    print(f'*---[Test param]---------------------------------------------------------*')
    print (f'usernameRegisterPage {locators.new_username}')
    sleep(0.25)
    print(f'emailRegisterPage {locators.email}')
    sleep(0.25)
    print(f'passwordRegisterPage {locators.new_password}')
    print(f' First Name    : {locators.first_name}')
    print(f' Last Name     : {locators.last_name}')
    print(f' Phone Number  : {locators.phonenum1}')
    print(f' City      : {locators.city}')
    print(f' Address   : {locators.address}')
    print(locators.admin_name)
    print(locators.admin_password)
    print(locators.middle_name)
    print(locators.country)
    print(locators.address_only)
